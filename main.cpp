...
int main()
{
	while (true)
	{
		cout << "Test Menu" << endl;
		cout << "---------" << endl;
		cout << "1. TestAddHead" << endl;
		cout << "2. TestAddTail" << endl;
		cout << "3. TestAddingArrays" << endl;
		cout << "4. TestFindAll" << endl;
		cout << "5. TestCopyCtor" << endl;
		cout << "6. TestAssignment" << endl;
		cout << "7. TestInsertBeforeAfter" << endl;
		cout << "8. TestInsertAt" << endl;
		cout << "9. TestRemove" << endl;
		cout << "10. TestRemoveHeadTail" << endl;
		cout << "11. TestOtherRemoval" << endl;
		cout << "12. TestRecursion" << endl;
		cout << "13. Exit" << endl;
